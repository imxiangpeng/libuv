...
static void fs_event_cb_file_current_dir(uv_fs_event_t *handle,
    ...
    uv_timer_start(&timer_event, _timer_cb, 1000, 5000);
}
...
int main(int argc, char **argv) {
    ...
    //ret = uv_fs_event_start(&fs_event, fs_event_cb_file_current_dir, "./watcher", 0);
    ret = uv_fs_event_start(&fs_event, fs_event_cb_file_current_dir, "./j2stbls/hrweek.json", 0);
    if (ret != 0) {
    ...
    //uv_timer_start(&timer_event, _timer_cb, 1000, 4000);
