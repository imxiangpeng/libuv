...
int dm_Device_DeviceInfo_init(struct dm_object *parent) {
    ...
    struct dm_object* ModelName = dm_object_new("ModelName", DM_TYPE_STRING, ModelName_getter, NULL, DeviceInfo);
    struct dm_object* SoftwareVersion = dm_object_new("SoftwareVersion", DM_TYPE_STRING, SoftwareVersion_getter, NULL, DeviceInfo);
